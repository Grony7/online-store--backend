...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item: Schema.Attribute.Component<'cart.cart-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant_colors: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isFromSupport: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    delivery_address: Schema.Attribute.Relation<
      ...
      'api::address.address'
    >;
    delivery_method: Schema.Attribute.Enumeration<['delivery', 'pickup']> &
      Schema.Attribute.Required;
    ...
    payment_method: Schema.Attribute.Enumeration<['online', 'cash']> &
      Schema.Attribute.Required;
    payment_session: Schema.Attribute.String & Schema.Attribute.Unique;
...
export interface ApiProductSpecProductSpec extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    value_string: Schema.Attribute.String;
  };
}
...
export interface ApiSpecificationSpecification
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fieldType: Schema.Attribute.Enumeration<['number', 'string', 'boolean']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::specification.specification'
